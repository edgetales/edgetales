...
_STRINGS = {
    ...
    "de": {
        ...
        "actions.quick_save": "Speichern",
        "actions.load": "Laden",
        "actions.load_label": "Laden",
        "actions.load_confirm": "Aktuelles Spiel verlassen und \u00ab{name}\u00bb laden?",
        ...
        "game.retry_orphan": "Keine Antwort erhalten.",
        ...
        "aria.chaos_bar": "Chaos {n} von 9 — {level}",
    ...
    "en": {
        ...
        "actions.quick_save": "Save",
        "actions.load": "Load",
        "actions.load_label": "Load",
        "actions.load_confirm": "Leave current game and load \u00ab{name}\u00bb?",
        ...
        "game.retry_orphan": "No response received.",
        ...
        "aria.chaos_bar": "Chaos {n} of 9 — {level}",
...
_GENRES = {
    "de": {
        ...
        "horror": f"{E['dark_moon']} Horror",
        "mystery": f"{E['crystal']} Mystery",
        ...
        "roman_empire": f"{E['shield']} R\u00f6misches Reich",
        "fairy_tale": f"{E['green_heart']} M\u00e4rchenwelt",
        "slice_of_life_90s": f"{E['mic']} Slice of Life 1990er",
        "outdoor_survival": f"{E['leaf']} Outdoor Survival",
        "post_apocalyptic": f"{E['tornado']} Postapokalypse",
    },
    "en": {
        "dark_fantasy": f"{E['castle']} Dark Fantasy",
        "high_fantasy": f"{E['scroll']} High Fantasy",
        ...
        "roman_empire": f"{E['shield']} Roman Empire",
        "fairy_tale": f"{E['green_heart']} Fairy Tale",
        "slice_of_life_90s": f"{E['mic']} Slice of Life 1990s",
        "outdoor_survival": f"{E['leaf']} Outdoor Survival",
        "post_apocalyptic": f"{E['tornado']} Post-Apocalyptic",
    },
}
...
_TONES = {
    "de": {
        ...
        "grounded_drama": f"{E['scales']} Geerdet & Dramatisch",
    ...
    "en": {
        ...
        "grounded_drama": f"{E['scales']} Grounded Drama",
...
_ARCHETYPES = {
    "de": {
        "outsider_loner": f"{E['dagger']} Einzelg\u00e4nger",
        "investigator": f"{E['search']} Ermittler",
        "trickster": f"{E['speech']} Trickbetr\u00fcger",
        "protector": f"{E['shield']} Krieger",
        "hardboiled": f"{E['fire']} Harter Hund",
        "scholar": f"{E['books']} Gelehrter",
        "healer": f"{E['heart_red']} Heiler",
        "inventor": f"{E['gear']} Erfinder",
        "artist": f"{E['microphone']} K\u00fcnstler",
    },
    "en": {
        "outsider_loner": f"{E['dagger']} Outsider",
        "investigator": f"{E['search']} Investigator",
        "trickster": f"{E['speech']} Con Artist",
        "protector": f"{E['shield']} Warrior",
        "hardboiled": f"{E['fire']} Hardboiled",
        "scholar": f"{E['books']} Scholar",
        "healer": f"{E['heart_red']} Healer",
        "inventor": f"{E['gear']} Inventor",
        "artist": f"{E['microphone']} Artist",
    },
}
